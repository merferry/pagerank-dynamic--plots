...
set output 'insertions-speedup-mean.pdf'
...
plot 'insertions.csv' \
  ...
  '' using 4:($9 /$11):($4>=1e-3 && $4 <1e-1? sprintf("%.1f", $5 /$11) : "") with labels notitle offset character 0,character 3.2 textcolor linetype 7, \
  '' using 4:($9 /$11):($4==1e-1? sprintf("%.1f", $5 /$11) : "") with labels notitle offset character -1.4,character 3.2 textcolor linetype 7, \
  ...
  '' using 4:($9 /$11):($4>=1e-3 && $4 <1e-1? sprintf("%.1f", $7 /$11) : "") with labels notitle offset character 0,character 1.2 textcolor linetype 6, \
  '' using 4:($9 /$11):($4==1e-1? sprintf("%.1f", $7 /$11) : "") with labels notitle offset character -1.4,character 1.2 textcolor linetype 6, \
  ...
  '' using 4:($9 /$11):($4>=1e-3 && $4 <1e-1? sprintf("%.1f", $9 /$11) : "") with labels notitle offset character 0,character 2.2 textcolor linetype 1, \
  '' using 4:($9 /$11):($4==1e-1? sprintf("%.1f", $9 /$11) : "") with labels notitle offset character -1.4,character 2.2 textcolor linetype 1
