...
plot 'deletions.csv' \
  ...
  '' using 4:($9 /1000):($4>=1e-6 && $4 <1e-3? sprintf("%.1f", $9 /1000) : "") with labels notitle offset character -2.0,character 0.4 textcolor linetype 1, \
  '' using 4:($9 /1000):($4==1e-2? sprintf("%.1f", $9 /1000) : "") with labels notitle offset character -1.2,character 0.7 textcolor linetype 1, \
  ...
  '' using 4:($11/1000):($4==1e-2? sprintf("%.1f", $11/1000) : "") with labels notitle offset character -2.2,character 0.2 textcolor linetype 8, \
