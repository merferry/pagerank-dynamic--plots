...
set output 'deletions-error-mean.pdf'
...
plot 'deletions.csv' \
  ...
  '' using 4:($15) title 'Naive-dyn'     linestyle  2 with linespoints, \
  '' using 4:($17) title 'Dyn Traversal' linestyle  3 with linespoints, \
  '' using 4:($19) title 'Dyn Frontier'  linestyle  4 with linespoints
